...
"""
    ...
    for variant in variants:
        ...
        for i, sign in enumerate([-1, 1]):
            ...
            footprint.add_pad(
                FootprintPad(
                    ...
                    holes=[
                        PadHole(uuid_pad, DrillDiameter(pad_hole_diameter), [Vertex(Position(0.0, 0.0), Angle(0.0))])
                    ],
                )
            )
        ...
        # Silkscreen
        if variant.vertical:
            silk_pad_clearance_left = (body_diameter_nom / 2) - sqrt(pad_size[0] ** 2 + pad_size[1] ** 2) / 2
            silk_pad_clearance_right = variant.pitch - (body_diameter_nom / 2) - (pad_size[0] / 2) - line_width
...
def generate_3d(
    ...
    if pkg_type == 'R':
        ...
        if vertical:
            ...
            assembly.add_body(
                body_outer, 'body_outer_1', body_color, location=cq.Location((-pitch / 2, 0, vertical_standoff))
            )
            assembly.add_body(
                body_outer,
                'body_outer_2',
            ...
            assembly.add_body(
                body_outer, 'body_outer_1', body_color, location=cq.Location((-(body_length - outer_length) / 2, 0, 0))
            )
            assembly.add_body(
                body_outer, 'body_outer_2', body_color, location=cq.Location(((body_length - outer_length) / 2, 0, 0))
            )
        ...
        if vertical:
            ...
            body = cq.Workplane('YZ').cylinder(body_length, body_diameter / 2, centered=(True, False, True))
    ...
    leg_length = (
        ...
        - bend_radius
        + ((body_length + 2 * vertical_standoff + (leg_diameter / 2)) if vertical else (body_diameter / 2))
    )
    leg_path = (
        cq.Workplane('XZ')
        .vLine(leg_length)
...
if __name__ == '__main__':
    ...
    generate_pkg(
        ...
        name='DO-204AA',
        description='Diode outline package as specified by JEDEC DO-204AA. ' + 'Also known as DO-7.',
    ...
    generate_pkg(
        ...
        name='DO-204AC',
        description='Diode outline package as specified by JEDEC DO-204AC. ' + 'Also known as DO-15.',
    ...
    generate_pkg(
        ...
        name='DO-204AG',
        description='Diode outline package as specified by JEDEC DO-204AG. ' + 'Also known as DO-34.',
    ...
    generate_pkg(
        ...
        name='DO-204AH',
        description='Diode outline package as specified by JEDEC DO-204AH. ' + 'Also known as DO-35.',
    ...
    generate_pkg(
        ...
        name='DO-204AL',
        description='Diode outline package as specified by JEDEC DO-204AL. ' + 'Also known as DO-41.',
