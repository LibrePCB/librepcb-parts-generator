...
def test_polygon() -> None:
    polygon = Polygon(
        '743dbf3d-98e8-46f0-9a32-00e00d0e811f', Layer('sym_outlines'), Width(0.25), Fill(False), GrabArea(True)
    )
...
def test_footprint_pad() -> None:
    footprint_pad = FootprintPad(
        ...
        [
            PadHole(
                '5c4d39d3-35cc-4836-a082-693143ee9135', DrillDiameter(1.0), [Vertex(Position(0.0, 0.0), Angle(0.0))]
            ),
        ],
    )
    assert (
...
def create_footprint() -> Footprint:
    ...
    footprint.add_pad(
        FootprintPad(
            ...
            [
                PadHole(
                    '6100dd55-d3b3-4139-9085-d5a75e783c37', DrillDiameter(1.0), [Vertex(Position(0.0, 0.0), Angle(0.0))]
                ),
            ],
        )
    )
    polygon = Polygon(
        '5e18e4ea-5667-42b3-b60f-fcc91b0461d3', Layer('top_placement'), Width(0.25), Fill(False), GrabArea(True)
    )
...
def test_component_pad() -> None:
    ...
    assert (
        str(component_pad) == '(pad 67a7b034-b30b-4644-b8d3-d7a99606efdc (signal 9bccea5e-e23f-4b88-9de1-4be00dc0c12a))'
    )
...
def test_device() -> None:
    ...
    device.add_pad(
        ComponentPad('aec3f475-28c4-4508-ab4f-e1b618a0d77d', SignalUUID('726fd1ce-a01b-4287-bb61-e3ff165a0644'))
    )
    device.add_pad(
        ComponentPad('67a7b034-b30b-4644-b8d3-d7a99606efdc', SignalUUID('9bccea5e-e23f-4b88-9de1-4be00dc0c12a'))
    )
