...
from entities.component import Role, Signal, Required, Negated, Clock, ForcedNet, PinSignalMap, SignalUUID, TextDesignator, Gate, SymbolUUID, Suffix, Norm, Variant, Component, Deprecated, SchematicOnly, DefaultValue, Prefix
...
def test_component_pin_signal_map():
