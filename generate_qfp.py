...
DENSITY_LEVEL_A = {  # Most
    1.00: Excess(0.40, 0.50,  0.07, 0.40),
    0.80: Excess(0.35, 0.45,  0.06, 0.40),
    0.65: Excess(0.30, 0.40,  0.05, 0.40),
    0.50: Excess(0.25, 0.35,  0.03, 0.40),
    0.40: Excess(0.20, 0.30,  0.00, 0.40),
    0.35: Excess(0.20, 0.30, -0.01, 0.40)
}
DENSITY_LEVEL_B = {  # Nominal
    1.00: Excess(0.35, 0.45,  0.06, 0.20),
    0.80: Excess(0.30, 0.40,  0.05, 0.20),
    0.65: Excess(0.25, 0.35,  0.04, 0.20),
    0.50: Excess(0.20, 0.30,  0.02, 0.20),
    0.40: Excess(0.15, 0.25, -0.01, 0.20),
    0.35: Excess(0.15, 0.25, -0.02, 0.20)
}
DENSITY_LEVEL_C = {  # Least
    1.00: Excess(0.30, 0.40,  0.05, 0.10),
    0.80: Excess(0.25, 0.35,  0.04, 0.10),
    0.65: Excess(0.20, 0.30,  0.03, 0.10),
    0.50: Excess(0.15, 0.25,  0.01, 0.10),
    0.40: Excess(0.10, 0.20, -0.02, 0.10),
    0.35: Excess(0.10, 0.20, -0.03, 0.10)
}
