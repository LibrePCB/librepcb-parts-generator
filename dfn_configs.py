...
LEAD_WIDTH = {0.95: 0.45, 0.8: 0.35, 0.65: 0.35, 0.5: 0.30, 0.4: 0.25}
...
JEDEC_CONFIGS = [
    ...
    DfnConfig(
        2.0, 2.0, 0.5, 6, 0.95, 1.00, 0.40, 1.75, 0.80, 'V2020D-4,VCCD-4', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        2.0, 2.0, 0.5, 6, 0.75, 0.80, 0.40, 1.75, 0.80, 'W2020D-4,WCCD-4', no_exp=False
    ),  # no nominal exp_pad
    ...
    DfnConfig(
        3.0, 3.0, 0.65, 8, 0.95, 1.00, 0.30, 2.25, 1.30, 'V3030C-1,VEEC-1'
    ),  # no nominal exp_pad
    DfnConfig(
        3.0, 3.0, 0.65, 8, 0.95, 1.00, 0.40, 2.50, 1.75, 'V3030C-2,VEEC-2', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        3.0, 3.0, 0.65, 8, 0.75, 0.80, 0.40, 2.50, 1.75, 'W3030C-2,WEEC-2', no_exp=False
    ),  # no nominal exp_pad
    ...
    DfnConfig(
        3.0, 3.0, 0.5, 8, 0.95, 1.00, 0.40, 2.70, 1.75, 'V3030D-4,VEED-4', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        3.0, 3.0, 0.5, 8, 0.75, 0.80, 0.40, 2.70, 1.75, 'W3030D-4,WEED-4', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        3.0, 3.0, 0.5, 8, 0.95, 1.00, 0.55, 2.50, 1.50, 'V3030D-6,VEED-6', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        3.0, 3.0, 0.5, 8, 0.75, 0.80, 0.55, 2.50, 1.50, 'W3030D-6,WEED-6', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        3.0, 3.0, 0.5, 8, 0.95, 1.00, 0.45, 1.60, 1.60, 'V3030D-7,VEED-7', no_exp=False
    ),  # no nominal pad length and exp_pad
    DfnConfig(
        3.0, 3.0, 0.5, 8, 0.75, 0.80, 0.45, 1.60, 1.60, 'W3030D-7,WEED-7', no_exp=False
    ),  # no nominal pad length and exp_pad
    ...
    DfnConfig(
        3.0, 3.0, 0.5, 10, 0.95, 1.00, 0.40, 2.70, 1.75, 'V3030D-5,VEED-5', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        3.0, 3.0, 0.5, 10, 0.75, 0.80, 0.40, 2.70, 1.75, 'W3030D-5,WEED-5', no_exp=False
    ),  # no nominal exp_pad
    # Square, 3.5 x 3.5
    ...
    DfnConfig(
        4.0, 4.0, 0.65, 10, 0.95, 1.00, 0.40, 3.50, 2.80, 'V4040C,VGGC', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        4.0, 4.0, 0.65, 10, 0.75, 0.80, 0.40, 3.50, 2.80, 'W4040C,WGGC', no_exp=False
    ),  # no nominal exp_pad
    ...
    DfnConfig(
        2.0, 2.5, 0.5, 8, 0.95, 1.00, 0.55, 1.10, 0.80, 'V2025D-2,VCDD-2'
    ),  # no nominal exp_pad
    DfnConfig(
        2.0, 2.5, 0.5, 8, 0.75, 0.80, 0.55, 1.10, 0.80, 'W2025D-2,WCDD-2'
    ),  # no nominal exp_pad
    # Rectangular, Type 1, 2.0 x 3.0
    DfnConfig(
        2.0, 3.0, 0.5, 6, 0.95, 1.00, 0.40, 1.00, 1.20, 'V2030D-1,VCED-1', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        2.0, 3.0, 0.5, 6, 0.75, 0.80, 0.40, 1.00, 1.20, 'W2030D-1,WCED-1', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        2.0, 3.0, 0.5, 8, 0.95, 1.00, 0.40, 1.75, 1.90, 'V2030D-2,VCED-2', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        2.0, 3.0, 0.5, 8, 0.75, 0.80, 0.40, 1.75, 1.90, 'W2030D-2,WCED-2', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        2.0, 3.0, 0.5, 8, 0.95, 1.00, 0.45, 1.60, 1.60, 'V2030D-3,VCED-3', no_exp=False
    ),  # no nominal pad length and exp_pad
    DfnConfig(
        2.0, 3.0, 0.5, 8, 0.75, 0.80, 0.45, 1.60, 1.60, 'W2030D-3,WCED-3', no_exp=False
    ),  # no nominal pad length and exp_pad
    DfnConfig(
        2.0, 3.0, 0.5, 8, 0.55, 0.65, 0.45, 1.60, 1.60, 'U2030D', no_exp=False
    ),  # no nominal pad length and exp_pad
    ...
    DfnConfig(
        3.0, 2.0, 0.95, 6, 0.95, 1.00, 0.30, 2.20, 0.60, 'V3020A,VECA'
    ),  # no nominal exp_pad, using manual values
    DfnConfig(
        3.0, 2.0, 0.65, 8, 0.95, 1.00, 0.30, 2.20, 0.60, 'V3020C,VECC'
    ),  # no nominal exp_pad, using manual values
    ...
    DfnConfig(
        4.0, 3.0, 0.5, 12, 0.95, 1.00, 0.40, 3.70, 1.80, 'V4030D-4,VGED-4', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        4.0, 3.0, 0.5, 12, 0.75, 0.80, 0.40, 3.70, 1.80, 'W4030D-4,WGED-4', no_exp=False
    ),  # no nominal exp_pad
    ...
    DfnConfig(
        6.0, 5.0, 0.5, 16, 0.95, 1.00, 0.55, 4.70, 3.40, 'V6050D-1,VLJD-1', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        6.0, 5.0, 0.5, 16, 0.75, 0.80, 0.55, 4.70, 3.40, 'W6050D-1,WLJD-1', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        6.0, 5.0, 0.5, 18, 0.95, 1.00, 0.55, 4.70, 3.40, 'V6050D-2,VLJD-2', no_exp=False
    ),  # no nominal exp_pad
    DfnConfig(
        6.0, 5.0, 0.5, 18, 0.75, 0.80, 0.55, 4.70, 3.40, 'W6050D-2,WLJD-2', no_exp=False
    ),  # no nominal exp_pad
]
